    ...
    <div class="auth-card">
      ...
      <form action="../Controller/loginController.php" method="POST">
        ...
        <div class="form-group <?php echo isset($errors['email']) ? 'has-error' : ''; ?>">
          ...
          <input type="text" name="email" class="form-control <?php echo isset($errors['email']) ? 'is-invalid' : ''; ?>" placeholder="e.g. adnan@gmail.com" value="<?php echo htmlspecialchars($email ?? ''); ?>"">
      ...
      <div class="auth-footer">
        Don't have an account? <a href="user_views/createAccount.php">Register</a>
      </div>
    </div>
  </div>
</body>
